...
public class ActuateClimberOne extends CommandBase {
  ...
  public ActuateClimberOne(ClimberSubsystem climberSubsystem, IntakeLiftSubsystem intakeLiftSubsystem, double climberSpeed) {
  ...
  public void execute() {
    ...
    if(intakeLiftPosition <= 0.9){
      m_ClimberSubsystem.setClimber1Percentage(climberPercent);
    }
    else{
      m_ClimberSubsystem.setClimber1Percentage(0);
    }
  }
