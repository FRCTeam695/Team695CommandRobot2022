...
public class ActuateBothClimbers extends CommandBase {
  ...
  public ActuateBothClimbers(ClimberSubsystem climberSubsystem, IntakeLiftSubsystem intakeLiftSubsystem, double climberSpeed) {
  ...
  public void execute() {
    ...
    if(intakeLiftPosition <= 0.9){
      m_ClimberSubsystem.setBothClimberPercentage(climberPercent, climberPercent);
    }
    else{
      m_ClimberSubsystem.setBothClimberPercentage(0, 0);
    }
  }
