 ...
 */
public class InstrumentedRamseteCommand extends CommandBase {
   ...
   */
  public InstrumentedRamseteCommand(
  ...
  public void execute() {
    ...
    if (m_usePID) {
      ...
      double leftWheelsPID = m_leftController.calculate(m_speeds.get().leftMetersPerSecond, leftSpeedSetpoint);
      leftOutput =
          leftFeedforward
              + leftWheelsPID;

      double rightWheelsPID = m_rightController.calculate(
    ...
    SmartDashboard.putNumber("Current Time", curTime);
